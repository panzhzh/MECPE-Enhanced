...
tf.app.flags.DEFINE_string('video_emb_file', './data/features/video_embedding_4096.npy', 'ndarray (13620, 4096)')
tf.app.flags.DEFINE_string('audio_emb_file', './data/features/audio_embedding_6373.npy', 'ndarray (13620, 6373)')
